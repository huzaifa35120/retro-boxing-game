...
const RULE_PAGES = [
  ...
  { title: 'THE GUARD', lines: [
    ...
    'SO HEAD PUNCHES AND BODY SHOTS BOTH COME',
    'OFF IT.',
    '',
    'AN UPPERCUT IS WHAT BEATS A GUARD, COMING',
    'UP INSIDE THE ARMS - AND EVEN THAT IS',
    'CAUGHT ABOUT HALF THE TIME.',
    '',
    'EVERY PUNCH THE GUARD CATCHES COSTS YOU',
    'WIND, AND BODY SHOTS COST THE MOST. A MAN',
    'CAN BE EMPTIED OUT BEHIND HIS OWN GLOVES',
    'WITHOUT TAKING A MARK ON HIM.',
    '',
    'YOU CANNOT MOVE FAR BEHIND A GUARD, AND',
    'THE WIND COMES BACK SLOWLY WHILE IT IS UP.',
  ]},
  { title: 'DUCKING AND SLIPPING', lines: [
    'K DUCKS UNDER STRAIGHTS AND HOOKS, AND',
    'INTO BODY SHOTS.',
    '',
    'A CROUCH COSTS NOTHING TO HOLD AND GIVES',
    'NOTHING BACK - STAY DOWN AS LONG AS YOU',
    'LIKE, YOU JUST GET NO BREATH WHILE YOU',
    'ARE THERE.',
    '',
    'AND AN UPPERCUT ALWAYS LANDS ON A',
    'CROUCHING MAN - CLEAN, THROUGH ANY GUARD,',
    'AND FOR THREE TIMES ITS DAMAGE. GO UP THE',
    'MIDDLE ON A MAN WHO LIVES DOWN THERE.',
    '',
    'Q AND E SLIP THE HEAD OFF STRAIGHTS AND',
    'UPPERCUTS. HOOKS COME AROUND IT.',
  ]},
  { title: 'FOOTWORK', lines: [
    'WASD WALKS HIM ABOUT. IT IS THE ONE THING',
    'THAT COSTS NOTHING, THOUGH YOU GET YOUR',
    'BREATH BACK SLOWER ON THE MOVE THAN',
    'STANDING STILL.',
    '',
    'SHIFT AND A DIRECTION DASHES THAT WAY:',
    'IN BEHIND A JAB, OR STRAIGHT BACK OUT OF',
    'RANGE. SHIFT ON ITS OWN GOES AT HIM.',
    '',
    'A DASH COSTS ABOUT WHAT A CROSS COSTS, SO',
    'A MAN WHO DASHES ABOUT THE RING HAS',
    'NOTHING LEFT TO PUNCH WITH. IT WILL NOT',
    'CHAIN EITHER - ONE AT A TIME.',
    '',
    'YOU CANNOT DASH OUT OF A CROUCH.',
  ]},
