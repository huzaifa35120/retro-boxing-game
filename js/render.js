...
const DEFENCE_LINES = [
  ...
  ['DUCK', 'DOWN', 'GOES UNDER STRAIGHTS AND HOOKS. UPPERCUTS',
                   'AND BODY LAND. LEGS GO AFTER 1.5 SECONDS.'],
...
const RULE_PAGES = [
  ...
  { title: 'DEFENCE', lines: [
    ...
    'MOVE, AND A CROUCH IS ONLY GOOD FOR THE',
    'FIRST 0.8 SECONDS. AFTER THAT HIS LEGS GO:',
    'HE RISES, IS BEING HIT BY 1.4, AND AT 1.5',
    'IT GIVES OUT ENTIRELY - HE MUST STAND A',
    'MOMENT BEFORE HE CAN GO DOWN AGAIN.',
  ]},
