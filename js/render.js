...
const RULE_PAGES = [
  ...
  { title: 'DEFENCE', lines: [
    'SPACE GUARDS: IT STOPS EVERY HEAD PUNCH',
    'AND CATCHES ABOUT HALF THE BODY WORK, BUT',
    'EVERY PUNCH IT CATCHES COSTS YOU WIND.',
    '',
    'K DUCKS UNDER STRAIGHTS AND HOOKS, AND',
    'INTO BODY SHOTS. AN UPPERCUT ALWAYS LANDS',
    'ON A CROUCHING MAN - CLEAN, THROUGH ANY',
    'GUARD, AND FOR THREE TIMES ITS DAMAGE.',
