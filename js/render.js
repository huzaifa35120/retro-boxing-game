...
const RULE_PAGES = [
  ...
  { title: 'DUCKING AND SLIPPING', lines: [
    ...
    'INTO BODY SHOTS.',
    '',
    'AN UPPERCUT ALWAYS LANDS ON A CROUCHING',
    'MAN - CLEAN, THROUGH ANY GUARD, AND FOR',
    'THREE TIMES ITS DAMAGE. IF HE IS LIVING',
    'DOWN THERE, GO UP THE MIDDLE.',
    '',
    'A CROUCH BURNS WIND ALL THE TIME IT IS',
    'HELD. RUN IT DRY AND HIS LEGS GO.',
    '',
    'Q AND E SLIP THE HEAD OFF STRAIGHTS AND',
    'UPPERCUTS. HOOKS COME AROUND IT.',
    '',
    'SHIFT STEPS IN: A STRIDE OFF THE BACK',
    'FOOT TO CLOSE HIM DOWN, FOR A LITTLE WIND.',
  ]},
